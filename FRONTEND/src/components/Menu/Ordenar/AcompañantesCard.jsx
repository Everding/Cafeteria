...
const AcompanantesCard = ({ product, onUpdate, onDelete }) => {
  ...
  const materiasEjemplo = [
    'Papas', 'Tomate', 'Lechuga', 'Cebolla', 'Aceite',
    'Queso', 'Sal', 'Pimienta', 'Ajo', 'Pan'
  ];
  ...
  return (
    <div className="AcompanantesCard-wrapper">
      <div className="AcompanantesCard">
        {editing ? (
          <>
            <input
              type="text"
              ...
              className="AcompanantesCard-title-edit"
              placeholder="Título"
              maxLength={50}
            />
            <img src={imagen} alt="Producto" className="AcompanantesCard-image" />
            ...
            />
            <div className="AcompanantesCard-description-edit-container">
              <textarea
                className="AcompanantesCard-description-edit"
                value={descripcion}
                onChange={e => {
            ...
            <div className="AcompanantesCard-materias">
            ...
            <div className="AcompanantesCard-actions">
          ...
          <>
            <h3 className="AcompanantesCard-title">{titulo}</h3>
            <img src={imagen} alt="Producto" className="AcompanantesCard-image" />
            <div className="AcompanantesCard-description-scroll">
              <p className="AcompanantesCard-description" title={descripcion}>{descripcion}</p>
            </div>
            <div className="AcompanantesCard-quantity">
              <button onClick={decrementar}>-</button>
              <span className="AcompanantesCard-quantity-value">{cantidad}</span>
              <button onClick={incrementar}>+</button>
            </div>
            <button className="AcompanantesCard-add">Agregar al carrito</button>
            <p className="AcompanantesCard-price"><strong>Precio:</strong> ${precio}</p>
          </>
        )}
      </div>
      {!editing && (
        <div className="AcompanantesCard-editDelete">
...
export default AcompanantesCard;
